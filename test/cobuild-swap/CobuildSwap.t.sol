...
contract CobuildSwapBaseFork_DeployProxy_Test is Test {
    ...
    function _deployFreshProxy() internal {
        ...
        address JB_TOKENS = address(0xA59e9F424901fB9DBD8913a9A32A081F9425bf36);
        address WETH9 = address(0x4200000000000000000000000000000000000006);
        bytes memory initData = abi.encodeCall(
            CobuildSwap.initialize,
            (USDC, ZORA, UNIVERSAL_ROUTER, JB_DIRECTORY, JB_TOKENS, WETH9, EXECUTOR, FEE_COLLECTOR, feeBps, minFeeAbs)
        );
